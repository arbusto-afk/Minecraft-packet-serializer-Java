	...
	public static class login{
		public static class toClient{
			...
			static class packet_success extends PacketBase{
				BigInteger uuid;
				String username;
				Tuple3<String, String, Object>[] properties;
				...
				public static packet_success readFrom(ByteBuffer buf){
					...
					Tuple3<String, String, Object>[] properties = ProtocolDeserializers.readVarintPrefixedArr(buf, aux1 ->Tuple3.readFrom(buf, aux2 ->ProtocolDeserializers.readString(buf), aux3 ->ProtocolDeserializers.readString(buf), aux25 -> "nullNOKNOWNCLASS@FlattenableBuilder"), Tuple3[]::new);
			...
			static class packet_login_plugin_request extends PacketBase{
				...
				public static packet_login_plugin_request readFrom(ByteBuffer buf){
					...
					Object data = "nonDefinedNative-restBuffer@FlattenableBuilder";
		...
		public static class toServer{
			...
			static class packet_login_plugin_response extends PacketBase{
				...
				public static packet_login_plugin_response readFrom(ByteBuffer buf){
					Integer messageId = ProtocolDeserializers.readVarInt(buf);
					Object data_option = "nullNOKNOWNCLASS@FlattenableBuilder";
		...
		public static class toClient{
			...
			static class packet_registry_data extends PacketBase{
				...
				public static packet_registry_data readFrom(ByteBuffer buf){
					...
					Tuple2<String, Object>[] entries = ProtocolDeserializers.readVarintPrefixedArr(buf, aux4 ->Tuple2.readFrom(buf, aux5 ->ProtocolDeserializers.readString(buf), "nullNOKNOWNCLASS@FlattenableBuilder"), Tuple2[]::new);
			...
			static class packet_remove_resource_pack extends PacketBase{
				...
				public packet_remove_resource_pack(
					...
					this.uuid_option = uuid_option;
				}
				public static packet_remove_resource_pack readFrom(ByteBuffer buf){
					Object uuid_option = "nullNOKNOWNCLASS@FlattenableBuilder";
			...
			static class packet_add_resource_pack extends PacketBase{
				...
				public packet_add_resource_pack(
					...
					this.hash = hash;
					this.forced = forced;
					this.promptMessage_option = promptMessage_option;
				}
				public static packet_add_resource_pack readFrom(ByteBuffer buf){
					...
					Object promptMessage_option = "nullNOKNOWNCLASS@FlattenableBuilder";
					return new packet_add_resource_pack(
						uuid,
						url,
						hash,
						forced,
						promptMessage_option
					);
				}
			}
			static class packet_feature_flags extends PacketBase{
				...
				public static packet_feature_flags readFrom(ByteBuffer buf){
					String[] features = ProtocolDeserializers.readVarintPrefixedArr(buf, aux6 ->ProtocolDeserializers.readString(buf), String[]::new);
			...
			static class packet_tags extends PacketBase{
				...
				public static packet_tags readFrom(ByteBuffer buf){
					Tuple2<String, Tuple2<String, Integer[]>[]>[] tags = ProtocolDeserializers.readVarintPrefixedArr(buf, aux7 ->Tuple2.readFrom(buf, aux8 ->ProtocolDeserializers.readString(buf), aux9 ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux10 ->Tuple2.readFrom(buf, aux11 ->ProtocolDeserializers.readString(buf), aux12 ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux13 ->ProtocolDeserializers.readVarInt(buf), Integer[]::new)), Tuple2[]::new)), Tuple2[]::new);
		...
		public static class toClient{
			...
			static class packet_statistics extends PacketBase{
				...
				public static packet_statistics readFrom(ByteBuffer buf){
					Tuple3<Integer, Integer, Integer>[] entries = ProtocolDeserializers.readVarintPrefixedArr(buf, aux14 ->Tuple3.readFrom(buf, aux15 ->ProtocolDeserializers.readVarInt(buf), aux16 ->ProtocolDeserializers.readVarInt(buf), aux17 ->ProtocolDeserializers.readVarInt(buf)), Tuple3[]::new);
			...
			static class packet_boss_bar extends PacketBase{
				...
				public static packet_boss_bar readFrom(ByteBuffer buf){
					...
					Integer action = ProtocolDeserializers.readVarInt(buf);
					String title = (action.equals(0))||(action.equals(3)) ? ProtocolDeserializers.readString(buf) : null;
					Float health = (action.equals(0))||(action.equals(2)) ? ProtocolDeserializers.readF32(buf) : null;
					Integer color = (action.equals(0))||(action.equals(4)) ? ProtocolDeserializers.readVarInt(buf) : null;
					Integer dividers = (action.equals(0))||(action.equals(4)) ? ProtocolDeserializers.readVarInt(buf) : null;
					Short flags = (action.equals(0))||(action.equals(5)) ? ProtocolDeserializers.readU8(buf) : null;
			...
			static class packet_chunk_biomes extends PacketBase{
				...
				public static packet_chunk_biomes readFrom(ByteBuffer buf){
					Tuple3<Integer, Integer, BitSet>[] biomes = ProtocolDeserializers.readVarintPrefixedArr(buf, aux18 ->Tuple3.readFrom(buf, aux19 ->ProtocolDeserializers.readI32(buf), aux20 ->ProtocolDeserializers.readI32(buf), aux21 ->BitSet.valueOf(aux22 ->buf.get(new byte[ProtocolDeserializers.readVarInt(buf)]))), Tuple3[]::new);
			...
			static class packet_tab_complete extends PacketBase{
				...
				public static packet_tab_complete readFrom(ByteBuffer buf){
					...
					Tuple2<String, Object>[] matches = ProtocolDeserializers.readVarintPrefixedArr(buf, aux23 ->Tuple2.readFrom(buf, aux24 ->ProtocolDeserializers.readString(buf), "nullNOKNOWNCLASS@FlattenableBuilder"), Tuple2[]::new);
			...
			static class packet_declare_commands extends PacketBase{
				...
				public static packet_declare_commands readFrom(ByteBuffer buf){
					Tuple8<Integer, Integer, Integer, Integer, Integer, Integer[], Object, Object>[] nodes = ProtocolDeserializers.readVarintPrefixedArr(buf, aux25 ->Tuple8.readFrom(buf, aux26 ->(int)(ProtocolDeserializers.peekI8(buf) & 22), aux27 ->(int)(ProtocolDeserializers.peekI8(buf) & 22), aux28 ->(int)(ProtocolDeserializers.peekI8(buf) & 22), aux29 ->(int)(ProtocolDeserializers.peekI8(buf) & 22), aux30 ->(int)(ProtocolDeserializers.readI8(buf) & 23), aux31 ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux32 ->ProtocolDeserializers.readVarInt(buf), Integer[]::new), aux33 ->readSwitchOfflags/has_redirect_node(), aux34 ->readSwitchOfflags/command_node_type()), Tuple8[]::new);
			...
			static class packet_window_items extends PacketBase{
				...
				public static packet_window_items readFrom(ByteBuffer buf){
					...
					Tuple2<Byte, Object>[] items = ProtocolDeserializers.readVarintPrefixedArr(buf, aux35 ->Tuple2.readFrom(buf, aux36 ->ProtocolDeserializers.readI8(buf), aux37 ->readSwitchOfitemCount()), Tuple2[]::new);
					Byte carriedItem_itemCount = ProtocolDeserializers.readI8(buf);
					Integer carriedItem_itemId = (itemCount.equals(0)) ? ProtocolDeserializers.readVarInt(buf) : null;
					Integer carriedItem_addedComponentCount = (itemCount.equals(0)) ? ProtocolDeserializers.readVarInt(buf) : null;
					Integer carriedItem_removedComponentCount = (itemCount.equals(0)) ? ProtocolDeserializers.readVarInt(buf) : null;
					Tuple2<Integer, Object>[] carriedItem_components = (itemCount.equals(0)) ? ProtocolDeserializers.readFixedArr(buf, aux38 ->Tuple2.readFrom(buf, aux39 ->ProtocolDeserializers.readVarInt(buf), aux40 ->readSwitchOftype()), Tuple2[]::new, carriedItem_components_addedComponentCount) : null;
					Integer[] carriedItem_removeComponents = (itemCount.equals(0)) ? ProtocolDeserializers.readFixedArr(buf, aux41 ->ProtocolDeserializers.readVarInt(buf), Integer[]::new, carriedItem_removeComponents_removedComponentCount) : null;
			...
			static class packet_set_slot extends PacketBase{
				...
				public static packet_set_slot readFrom(ByteBuffer buf){
					...
					Integer item_itemId = (itemCount.equals(0)) ? ProtocolDeserializers.readVarInt(buf) : null;
					Integer item_addedComponentCount = (itemCount.equals(0)) ? ProtocolDeserializers.readVarInt(buf) : null;
					Integer item_removedComponentCount = (itemCount.equals(0)) ? ProtocolDeserializers.readVarInt(buf) : null;
					Tuple2<Integer, Object>[] item_components = (itemCount.equals(0)) ? ProtocolDeserializers.readFixedArr(buf, aux42 ->Tuple2.readFrom(buf, aux43 ->ProtocolDeserializers.readVarInt(buf), aux44 ->readSwitchOftype()), Tuple2[]::new, item_components_addedComponentCount) : null;
					Integer[] item_removeComponents = (itemCount.equals(0)) ? ProtocolDeserializers.readFixedArr(buf, aux45 ->ProtocolDeserializers.readVarInt(buf), Integer[]::new, item_removeComponents_removedComponentCount) : null;
			...
			static class packet_chat_suggestions extends PacketBase{
				...
				public static packet_chat_suggestions readFrom(ByteBuffer buf){
					Integer action = ProtocolDeserializers.readVarInt(buf);
					String[] entries = ProtocolDeserializers.readVarintPrefixedArr(buf, aux46 ->ProtocolDeserializers.readString(buf), String[]::new);
			...
			static class packet_damage_event extends PacketBase{
				...
				public packet_damage_event(
					...
					this.sourcePosition_option = sourcePosition_option;
				}
				public static packet_damage_event readFrom(ByteBuffer buf){
					...
					Object sourcePosition_option = "nullNOKNOWNCLASS@FlattenableBuilder";
					return new packet_damage_event(
						entityId,
						sourceTypeId,
						sourceCauseId,
						sourceDirectId,
						sourcePosition_option
					);
				}
			}
			static class packet_debug_sample extends PacketBase{
				...
				public static packet_debug_sample readFrom(ByteBuffer buf){
					Long[] sample = ProtocolDeserializers.readVarintPrefixedArr(buf, aux47 ->ProtocolDeserializers.readI64(buf), Long[]::new);
					Integer type = ProtocolDeserializers.readVarInt(buf);
			...
			static class packet_hide_message extends PacketBase{
				...
				public static packet_hide_message readFrom(ByteBuffer buf){
					...
					BitSet signature = (id.equals(0)) ? Bitset.valueOf(buf.get(new byte[256])) : null;
			...
			nullnullnullstatic class packet_profileless_chat extends PacketBase{
				...
				public static packet_profileless_chat readFrom(ByteBuffer buf){
					...
					String type_chat_translationKey = (registryIndex.equals(0)) ? ProtocolDeserializers.readString(buf) : null;
					Integer[] type_chat_parameters = (registryIndex.equals(0)) ? ProtocolDeserializers.readVarintPrefixedArr(buf, aux48 ->ProtocolDeserializers.readVarInt(buf), Integer[]::new) : null;
					String type_chat_style = (registryIndex.equals(0)) ? ProtocolDeserializers.readString(buf) : null;
					String type_narration_translationKey = (registryIndex.equals(0)) ? ProtocolDeserializers.readString(buf) : null;
					Integer[] type_narration_parameters = (registryIndex.equals(0)) ? ProtocolDeserializers.readVarintPrefixedArr(buf, aux49 ->ProtocolDeserializers.readVarInt(buf), Integer[]::new) : null;
					String type_narration_style = (registryIndex.equals(0)) ? ProtocolDeserializers.readString(buf) : null;
					String name = ProtocolDeserializers.readString(buf);
					Object target_option = "nullNOKNOWNCLASS@FlattenableBuilder";
			...
			static class packet_explosion extends PacketBase{
				...
				public packet_explosion(
					...
					this.range_option = range_option;
				}
				public static packet_explosion readFrom(ByteBuffer buf){
					...
					Tuple3<Byte, Byte, Byte>[] affectedBlockOffsets = ProtocolDeserializers.readVarintPrefixedArr(buf, aux50 ->Tuple3.readFrom(buf, aux51 ->ProtocolDeserializers.readI8(buf), aux52 ->ProtocolDeserializers.readI8(buf), aux53 ->ProtocolDeserializers.readI8(buf)), Tuple3[]::new);
					...
					Integer small_explosion_particle_data_itemId = (small_explosion_particle_type.equals(small_explosion_particle_type_map.get("item"))) ? (small_explosion_particle_data_itemCount.equals(small_explosion_particle_data_0)) ? ProtocolDeserializers.readVarInt(buf) : null : null;
					Integer small_explosion_particle_data_addedComponentCount = (small_explosion_particle_type.equals(small_explosion_particle_type_map.get("item"))) ? (small_explosion_particle_data_itemCount.equals(small_explosion_particle_data_0)) ? ProtocolDeserializers.readVarInt(buf) : null : null;
					Integer small_explosion_particle_data_removedComponentCount = (small_explosion_particle_type.equals(small_explosion_particle_type_map.get("item"))) ? (small_explosion_particle_data_itemCount.equals(small_explosion_particle_data_0)) ? ProtocolDeserializers.readVarInt(buf) : null : null;
					Tuple2<Integer, Object>[] small_explosion_particle_data_components = (small_explosion_particle_type.equals(small_explosion_particle_type_map.get("item"))) ? (small_explosion_particle_data_itemCount.equals(small_explosion_particle_data_0)) ? ProtocolDeserializers.readFixedArr(buf, aux54 ->Tuple2.readFrom(buf, aux55 ->ProtocolDeserializers.readVarInt(buf), aux56 ->readSwitchOftype()), Tuple2[]::new, small_explosion_particle_data_components_addedComponentCount) : null : null;
					Integer[] small_explosion_particle_data_removeComponents = (small_explosion_particle_type.equals(small_explosion_particle_type_map.get("item"))) ? (small_explosion_particle_data_itemCount.equals(small_explosion_particle_data_0)) ? ProtocolDeserializers.readFixedArr(buf, aux57 ->ProtocolDeserializers.readVarInt(buf), Integer[]::new, small_explosion_particle_data_removeComponents_removedComponentCount) : null : null;
					...
					Integer large_explosion_particle_data_itemId = (large_explosion_particle_type.equals(large_explosion_particle_type_map.get("item"))) ? (large_explosion_particle_data_itemCount.equals(large_explosion_particle_data_0)) ? ProtocolDeserializers.readVarInt(buf) : null : null;
					Integer large_explosion_particle_data_addedComponentCount = (large_explosion_particle_type.equals(large_explosion_particle_type_map.get("item"))) ? (large_explosion_particle_data_itemCount.equals(large_explosion_particle_data_0)) ? ProtocolDeserializers.readVarInt(buf) : null : null;
					Integer large_explosion_particle_data_removedComponentCount = (large_explosion_particle_type.equals(large_explosion_particle_type_map.get("item"))) ? (large_explosion_particle_data_itemCount.equals(large_explosion_particle_data_0)) ? ProtocolDeserializers.readVarInt(buf) : null : null;
					Tuple2<Integer, Object>[] large_explosion_particle_data_components = (large_explosion_particle_type.equals(large_explosion_particle_type_map.get("item"))) ? (large_explosion_particle_data_itemCount.equals(large_explosion_particle_data_0)) ? ProtocolDeserializers.readFixedArr(buf, aux58 ->Tuple2.readFrom(buf, aux59 ->ProtocolDeserializers.readVarInt(buf), aux60 ->readSwitchOftype()), Tuple2[]::new, large_explosion_particle_data_components_addedComponentCount) : null : null;
					Integer[] large_explosion_particle_data_removeComponents = (large_explosion_particle_type.equals(large_explosion_particle_type_map.get("item"))) ? (large_explosion_particle_data_itemCount.equals(large_explosion_particle_data_0)) ? ProtocolDeserializers.readFixedArr(buf, aux61 ->ProtocolDeserializers.readVarInt(buf), Integer[]::new, large_explosion_particle_data_removeComponents_removedComponentCount) : null : null;
					...
					String soundName = (soundId.equals(0)) ? ProtocolDeserializers.readString(buf) : null;
					Object range_option = (soundId.equals(0)) ? "nullNOKNOWNCLASS@FlattenableBuilder" : null;
			...
			static class packet_map_chunk extends PacketBase{
				...
				public static packet_map_chunk readFrom(ByteBuffer buf){
					...
					Tuple5<Integer, Integer, Short, Integer, String>[] blockEntities = ProtocolDeserializers.readVarintPrefixedArr(buf, aux62 ->Tuple5.readFrom(buf, aux63 ->(int)(ProtocolDeserializers.peekI8(buf) & 22), aux64 ->(int)(ProtocolDeserializers.readI8(buf) & 23), aux65 ->ProtocolDeserializers.readI16(buf), aux66 ->ProtocolDeserializers.readVarInt(buf), aux67 ->ProtocolDeserializers.readString(buf)), Tuple5[]::new);
					Long[] skyLightMask = ProtocolDeserializers.readVarintPrefixedArr(buf, aux68 ->ProtocolDeserializers.readI64(buf), Long[]::new);
					Long[] blockLightMask = ProtocolDeserializers.readVarintPrefixedArr(buf, aux69 ->ProtocolDeserializers.readI64(buf), Long[]::new);
					Long[] emptySkyLightMask = ProtocolDeserializers.readVarintPrefixedArr(buf, aux70 ->ProtocolDeserializers.readI64(buf), Long[]::new);
					Long[] emptyBlockLightMask = ProtocolDeserializers.readVarintPrefixedArr(buf, aux71 ->ProtocolDeserializers.readI64(buf), Long[]::new);
					Short[][] skyLight = ProtocolDeserializers.readVarintPrefixedArr(buf, aux72 ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux73 ->ProtocolDeserializers.readU8(buf), Short[]::new), Short[]::new);
					Short[][] blockLight = ProtocolDeserializers.readVarintPrefixedArr(buf, aux74 ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux75 ->ProtocolDeserializers.readU8(buf), Short[]::new), Short[]::new);
			...
			static class packet_world_particles extends PacketBase{
				...
				public static packet_world_particles readFrom(ByteBuffer buf){
					...
					Integer particle_data_itemId = (particle_type.equals(particle_type_map.get("item"))) ? (particle_data_itemCount.equals(particle_data_0)) ? ProtocolDeserializers.readVarInt(buf) : null : null;
					Integer particle_data_addedComponentCount = (particle_type.equals(particle_type_map.get("item"))) ? (particle_data_itemCount.equals(particle_data_0)) ? ProtocolDeserializers.readVarInt(buf) : null : null;
					Integer particle_data_removedComponentCount = (particle_type.equals(particle_type_map.get("item"))) ? (particle_data_itemCount.equals(particle_data_0)) ? ProtocolDeserializers.readVarInt(buf) : null : null;
					Tuple2<Integer, Object>[] particle_data_components = (particle_type.equals(particle_type_map.get("item"))) ? (particle_data_itemCount.equals(particle_data_0)) ? ProtocolDeserializers.readFixedArr(buf, aux76 ->Tuple2.readFrom(buf, aux77 ->ProtocolDeserializers.readVarInt(buf), aux78 ->readSwitchOftype()), Tuple2[]::new, particle_data_components_addedComponentCount) : null : null;
					Integer[] particle_data_removeComponents = (particle_type.equals(particle_type_map.get("item"))) ? (particle_data_itemCount.equals(particle_data_0)) ? ProtocolDeserializers.readFixedArr(buf, aux79 ->ProtocolDeserializers.readVarInt(buf), Integer[]::new, particle_data_removeComponents_removedComponentCount) : null : null;
			...
			static class packet_update_light extends PacketBase{
				...
				public static packet_update_light readFrom(ByteBuffer buf){
					...
					Long[] skyLightMask = ProtocolDeserializers.readVarintPrefixedArr(buf, aux80 ->ProtocolDeserializers.readI64(buf), Long[]::new);
					Long[] blockLightMask = ProtocolDeserializers.readVarintPrefixedArr(buf, aux81 ->ProtocolDeserializers.readI64(buf), Long[]::new);
					Long[] emptySkyLightMask = ProtocolDeserializers.readVarintPrefixedArr(buf, aux82 ->ProtocolDeserializers.readI64(buf), Long[]::new);
					Long[] emptyBlockLightMask = ProtocolDeserializers.readVarintPrefixedArr(buf, aux83 ->ProtocolDeserializers.readI64(buf), Long[]::new);
					Short[][] skyLight = ProtocolDeserializers.readVarintPrefixedArr(buf, aux84 ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux85 ->ProtocolDeserializers.readU8(buf), Short[]::new), Short[]::new);
					Short[][] blockLight = ProtocolDeserializers.readVarintPrefixedArr(buf, aux86 ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux87 ->ProtocolDeserializers.readU8(buf), Short[]::new), Short[]::new);
			...
			static class packet_login extends PacketBase{
				...
				public static packet_login readFrom(ByteBuffer buf){
					...
					String[] worldNames = ProtocolDeserializers.readVarintPrefixedArr(buf, aux88 ->ProtocolDeserializers.readString(buf), String[]::new);
			...
			static class packet_map extends PacketBase{
				...
				public static packet_map readFrom(ByteBuffer buf){
					...
					Short rows = (columns.equals(0)) ? ProtocolDeserializers.readU8(buf) : null;
					Short x = (columns.equals(0)) ? ProtocolDeserializers.readU8(buf) : null;
					Short y = (columns.equals(0)) ? ProtocolDeserializers.readU8(buf) : null;
					BitSet data = (columns.equals(0)) ? BitSet.valueOf(buf.get(new byte[ProtocolDeserializers.readVarInt(buf)])) : null;
			...
			static class packet_trade_list extends PacketBase{
				...
				public static packet_trade_list readFrom(ByteBuffer buf){
					...
					Tuple14<Integer, Integer, Integer, Tuple2<Integer, Object>[], Byte, Object, Object, Boolean, Integer, Integer, Integer, Integer, Float, Integer>[] trades = ProtocolDeserializers.readVarintPrefixedArr(buf, aux89 ->Tuple14.readFrom(buf, aux90 ->ProtocolDeserializers.readVarInt(buf), aux91 ->ProtocolDeserializers.readVarInt(buf), aux92 ->ProtocolDeserializers.readVarInt(buf), aux93 ->ProtocolDeserializers.readFixedArr(buf, aux94 ->Tuple2.readFrom(buf, aux95 ->ProtocolDeserializers.readVarInt(buf), aux96 ->readSwitchOftype()), Tuple2[]::new, trades_addedComponentCount), aux97 ->ProtocolDeserializers.readI8(buf), aux98 ->readSwitchOfitemCount(), nullNOKNOWNCLASS, aux99 ->ProtocolDeserializers.readBool(buf), aux100 ->ProtocolDeserializers.readI32(buf), aux101 ->ProtocolDeserializers.readI32(buf), aux102 ->ProtocolDeserializers.readI32(buf), aux103 ->ProtocolDeserializers.readI32(buf), aux104 ->ProtocolDeserializers.readF32(buf), aux105 ->ProtocolDeserializers.readI32(buf)), Tuple14[]::new);
			...
			static class packet_player_chat extends PacketBase{
				...
				//Unresolved buildable option
				Object unsignedChatContent_option;
				Integer filterType;
				Long[] filterTypeMask;
				Integer type_registryIndex;
				String type_chat_translationKey;
				...
				String networkName;
				//Unresolved buildable option
				Object networkTargetName_option;
				public packet_player_chat(
					...
					this.unsignedChatContent_option = unsignedChatContent_option;
					...
					this.networkTargetName_option = networkTargetName_option;
				}
				public static packet_player_chat readFrom(ByteBuffer buf){
					...
					Tuple2<Integer, Object>[] previousMessages = ProtocolDeserializers.readVarintPrefixedArr(buf, aux106 ->Tuple2.readFrom(buf, aux107 ->ProtocolDeserializers.readVarInt(buf), aux108 ->readSwitchOfid()), Tuple2[]::new);
					Object unsignedChatContent_option = "nullNOKNOWNCLASS@FlattenableBuilder";
					Integer filterType = ProtocolDeserializers.readVarInt(buf);
					Long[] filterTypeMask = (filterType.equals(2)) ? ProtocolDeserializers.readVarintPrefixedArr(buf, aux109 ->ProtocolDeserializers.readI64(buf), Long[]::new) : null;
					Integer type_registryIndex = ProtocolDeserializers.readVarInt(buf);
					String type_chat_translationKey = (registryIndex.equals(0)) ? ProtocolDeserializers.readString(buf) : null;
					Integer[] type_chat_parameters = (registryIndex.equals(0)) ? ProtocolDeserializers.readVarintPrefixedArr(buf, aux110 ->ProtocolDeserializers.readVarInt(buf), Integer[]::new) : null;
					String type_chat_style = (registryIndex.equals(0)) ? ProtocolDeserializers.readString(buf) : null;
					String type_narration_translationKey = (registryIndex.equals(0)) ? ProtocolDeserializers.readString(buf) : null;
					Integer[] type_narration_parameters = (registryIndex.equals(0)) ? ProtocolDeserializers.readVarintPrefixedArr(buf, aux111 ->ProtocolDeserializers.readVarInt(buf), Integer[]::new) : null;
					String type_narration_style = (registryIndex.equals(0)) ? ProtocolDeserializers.readString(buf) : null;
					String networkName = ProtocolDeserializers.readString(buf);
					Object networkTargetName_option = "nullNOKNOWNCLASS@FlattenableBuilder";
			...
			static class packet_player_remove extends PacketBase{
				...
				public static packet_player_remove readFrom(ByteBuffer buf){
					BigInteger[] players = ProtocolDeserializers.readVarintPrefixedArr(buf, aux112 ->ProtocolDeserializers.readUUID(buf), BigInteger[]::new);
			...
			static class packet_player_info extends PacketBase{
				...
				public static packet_player_info readFrom(ByteBuffer buf){
					...
					Tuple7<BigInteger, Object, Object, Object, Object, Object, Object>[] data = ProtocolDeserializers.readVarintPrefixedArr(buf, aux113 ->Tuple7.readFrom(buf, aux114 ->ProtocolDeserializers.readUUID(buf), aux115 ->readSwitchOfaction(), aux116 ->readSwitchOf../action(), aux117 ->readSwitchOf../action(), aux118 ->readSwitchOf../action(), aux119 ->readSwitchOf../action(), aux120 ->readSwitchOf../action()), Tuple7[]::new);
			...
			static class packet_face_player extends PacketBase{
				...
				public static packet_face_player readFrom(ByteBuffer buf){
					...
					Integer entityId = (isEntity.equals(true)) ? ProtocolDeserializers.readVarInt(buf) : null;
					Integer entity_feet_eyes = (isEntity.equals(isEntity_map.get("true"))) ? ProtocolDeserializers.readVarInt(buf) : null;
			...
			static class packet_unlock_recipes extends PacketBase{
				...
				public static packet_unlock_recipes readFrom(ByteBuffer buf){
					...
					String[] recipes1 = ProtocolDeserializers.readVarintPrefixedArr(buf, aux121 ->ProtocolDeserializers.readString(buf), String[]::new);
					String[] recipes2 = (action.equals(0)) ? ProtocolDeserializers.readVarintPrefixedArr(buf, aux122 ->ProtocolDeserializers.readString(buf), String[]::new) : null;
			...
			static class packet_entity_destroy extends PacketBase{
				...
				public static packet_entity_destroy readFrom(ByteBuffer buf){
					Integer[] entityIds = ProtocolDeserializers.readVarintPrefixedArr(buf, aux123 ->ProtocolDeserializers.readVarInt(buf), Integer[]::new);
			...
			static class packet_multi_block_change extends PacketBase{
				...
				public static packet_multi_block_change readFrom(ByteBuffer buf){
					...
					Integer[] records = ProtocolDeserializers.readVarintPrefixedArr(buf, aux124 ->ProtocolDeserializers.readVarInt(buf), Integer[]::new);
			...
			static class packet_select_advancement_tab extends PacketBase{
				...
				public static packet_select_advancement_tab readFrom(ByteBuffer buf){
					Object id_option = "nullNOKNOWNCLASS@FlattenableBuilder";
			...
			static class packet_scoreboard_objective extends PacketBase{
				...
				public packet_scoreboard_objective(
					...
					this.type = type;
					this.number_format_option = number_format_option;
					this.number_format_option = number_format_option;
				...
				public static packet_scoreboard_objective readFrom(ByteBuffer buf){
					String name = ProtocolDeserializers.readString(buf);
					Byte action = ProtocolDeserializers.readI8(buf);
					String displayText = (action.equals(0))||(action.equals(2)) ? ProtocolDeserializers.readString(buf) : null;
					Integer type = (action.equals(0))||(action.equals(2)) ? ProtocolDeserializers.readVarInt(buf) : null;
					Object number_format_option = (action.equals(0)) ? "nullNOKNOWNCLASS@FlattenableBuilder" : null;
					Object number_format_option = (action.equals(2)) ? "nullNOKNOWNCLASS@FlattenableBuilder" : null;
					String styling = (action.equals(0)) ? (styling_number_format.equals(styling_1))||(styling_number_format.equals(styling_2)) ? ProtocolDeserializers.readString(buf) : null : null;
					String styling = (action.equals(2)) ? (styling_number_format.equals(styling_1))||(styling_number_format.equals(styling_2)) ? ProtocolDeserializers.readString(buf) : null : null;
			...
			static class packet_set_passengers extends PacketBase{
				...
				public static packet_set_passengers readFrom(ByteBuffer buf){
					Integer entityId = ProtocolDeserializers.readVarInt(buf);
					Integer[] passengers = ProtocolDeserializers.readVarintPrefixedArr(buf, aux125 ->ProtocolDeserializers.readVarInt(buf), Integer[]::new);
			...
			static class packet_teams extends PacketBase{
				...
				public static packet_teams readFrom(ByteBuffer buf){
					...
					String name = (mode.equals(0))||(mode.equals(2)) ? ProtocolDeserializers.readString(buf) : null;
					Byte friendlyFire = (mode.equals(0))||(mode.equals(2)) ? ProtocolDeserializers.readI8(buf) : null;
					String nameTagVisibility = (mode.equals(0))||(mode.equals(2)) ? ProtocolDeserializers.readString(buf) : null;
					String collisionRule = (mode.equals(0))||(mode.equals(2)) ? ProtocolDeserializers.readString(buf) : null;
					Integer formatting = (mode.equals(0))||(mode.equals(2)) ? ProtocolDeserializers.readVarInt(buf) : null;
					String prefix = (mode.equals(0))||(mode.equals(2)) ? ProtocolDeserializers.readString(buf) : null;
					String suffix = (mode.equals(0))||(mode.equals(2)) ? ProtocolDeserializers.readString(buf) : null;
					String[] players = (mode.equals(0))||(mode.equals(3))||(mode.equals(4)) ? ProtocolDeserializers.readVarintPrefixedArr(buf, aux126 ->ProtocolDeserializers.readString(buf), String[]::new) : null;
			...
			static class packet_scoreboard_score extends PacketBase{
				...
				public packet_scoreboard_score(
					...
					this.value = value;
					this.display_name_option = display_name_option;
					this.number_format_option = number_format_option;
					this.styling = styling;
				}
				public static packet_scoreboard_score readFrom(ByteBuffer buf){
					...
					Object display_name_option = "nullNOKNOWNCLASS@FlattenableBuilder";
					Object number_format_option = "nullNOKNOWNCLASS@FlattenableBuilder";
					String styling = (number_format.equals(1))||(number_format.equals(2)) ? ProtocolDeserializers.readString(buf) : null;
			...
			static class packet_entity_sound_effect extends PacketBase{
				...
				//Unresolved buildable option
				Object soundEvent_range_option;
				...
				public packet_entity_sound_effect(
					...
					this.soundEvent_range_option = soundEvent_range_option;
				...
				public static packet_entity_sound_effect readFrom(ByteBuffer buf){
					Integer soundId = ProtocolDeserializers.readVarInt(buf);
					String soundEvent_resource = (soundId.equals(0)) ? ProtocolDeserializers.readString(buf) : null;
					Object soundEvent_range_option = (soundId.equals(0)) ? "nullNOKNOWNCLASS@FlattenableBuilder" : null;
			...
			static class packet_stop_sound extends PacketBase{
				...
				public static packet_stop_sound readFrom(ByteBuffer buf){
					Byte flags = ProtocolDeserializers.readI8(buf);
					Integer source = (flags.equals(1))||(flags.equals(3)) ? ProtocolDeserializers.readVarInt(buf) : null;
					String sound = (flags.equals(2))||(flags.equals(3)) ? ProtocolDeserializers.readString(buf) : null;
			...
			static class packet_advancements extends PacketBase{
				Boolean reset;
				Tuple5<String, Object, Object, String[][], Boolean>[] advancementMapping;
				String[] identifiers;
				Tuple2<String, Tuple2<String, Object>[]>[] progressMapping;
				...
				public static packet_advancements readFrom(ByteBuffer buf){
					Boolean reset = ProtocolDeserializers.readBool(buf);
					Tuple5<String, Object, Object, String[][], Boolean>[] advancementMapping = ProtocolDeserializers.readVarintPrefixedArr(buf, aux127 ->Tuple5.readFrom(buf, aux128 ->ProtocolDeserializers.readString(buf), "nullNOKNOWNCLASS@FlattenableBuilder", nullNOKNOWNCLASS, aux129 ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux130 ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux131 ->ProtocolDeserializers.readString(buf), String[]::new), String[]::new), aux132 ->ProtocolDeserializers.readBool(buf)), Tuple5[]::new);
					String[] identifiers = ProtocolDeserializers.readVarintPrefixedArr(buf, aux133 ->ProtocolDeserializers.readString(buf), String[]::new);
					Tuple2<String, Tuple2<String, Object>[]>[] progressMapping = ProtocolDeserializers.readVarintPrefixedArr(buf, aux134 ->Tuple2.readFrom(buf, aux135 ->ProtocolDeserializers.readString(buf), aux136 ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux137 ->Tuple2.readFrom(buf, aux138 ->ProtocolDeserializers.readString(buf), "nullNOKNOWNCLASS@FlattenableBuilder"), Tuple2[]::new)), Tuple2[]::new);
			...
			static class packet_entity_update_attributes extends PacketBase{
				...
				public static packet_entity_update_attributes readFrom(ByteBuffer buf){
					Integer entityId = ProtocolDeserializers.readVarInt(buf);
					Tuple3<Integer, Double, Tuple3<String, Double, Byte>[]>[] properties = ProtocolDeserializers.readVarintPrefixedArr(buf, aux139 ->Tuple3.readFrom(buf, aux140 ->ProtocolDeserializers.readVarInt(buf), aux141 ->ProtocolDeserializers.readF64(buf), aux142 ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux143 ->Tuple3.readFrom(buf, aux144 ->ProtocolDeserializers.readString(buf), aux145 ->ProtocolDeserializers.readF64(buf), aux146 ->ProtocolDeserializers.readI8(buf)), Tuple3[]::new)), Tuple3[]::new);
			...
			static class packet_declare_recipes extends PacketBase{
				...
				public static packet_declare_recipes readFrom(ByteBuffer buf){
					Tuple3<String, Integer, Object>[] recipes = ProtocolDeserializers.readVarintPrefixedArr(buf, aux147 ->Tuple3.readFrom(buf, aux148 ->ProtocolDeserializers.readString(buf), aux149 ->ProtocolDeserializers.readVarInt(buf), aux150 ->readSwitchOftype()), Tuple3[]::new);
			...
			static class packet_tags extends PacketBase{
				...
				public static packet_tags readFrom(ByteBuffer buf){
					Tuple2<String, Tuple2<String, Integer[]>[]>[] tags = ProtocolDeserializers.readVarintPrefixedArr(buf, aux151 ->Tuple2.readFrom(buf, aux152 ->ProtocolDeserializers.readString(buf), aux153 ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux154 ->Tuple2.readFrom(buf, aux155 ->ProtocolDeserializers.readString(buf), aux156 ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux157 ->ProtocolDeserializers.readVarInt(buf), Integer[]::new)), Tuple2[]::new)), Tuple2[]::new);
					return new packet_tags(
						tags
					);
				}
		...
		public static class toServer{
			...
			static class packet_chat_command_signed extends PacketBase{
				...
				public static packet_chat_command_signed readFrom(ByteBuffer buf){
					...
					Long timestamp = ProtocolDeserializers.readI64(buf);
					Long salt = ProtocolDeserializers.readI64(buf);
					Tuple2<String, BitSet>[] argumentSignatures = ProtocolDeserializers.readVarintPrefixedArr(buf, aux158 ->Tuple2.readFrom(buf, aux159 ->ProtocolDeserializers.readString(buf), aux160 ->Bitset.valueOf(aux161 ->buf.get(new byte[256]))), Tuple2[]::new);
			...
			static class packet_window_click extends PacketBase{
				...
				public static packet_window_click readFrom(ByteBuffer buf){
					...
					Tuple3<Short, Byte, Object>[] changedSlots = ProtocolDeserializers.readVarintPrefixedArr(buf, aux162 ->Tuple3.readFrom(buf, aux163 ->ProtocolDeserializers.readI16(buf), aux164 ->ProtocolDeserializers.readI8(buf), aux165 ->readSwitchOfitemCount()), Tuple3[]::new);
					Byte cursorItem_itemCount = ProtocolDeserializers.readI8(buf);
					Integer cursorItem_itemId = (itemCount.equals(0)) ? ProtocolDeserializers.readVarInt(buf) : null;
					Integer cursorItem_addedComponentCount = (itemCount.equals(0)) ? ProtocolDeserializers.readVarInt(buf) : null;
					Integer cursorItem_removedComponentCount = (itemCount.equals(0)) ? ProtocolDeserializers.readVarInt(buf) : null;
					Tuple2<Integer, Object>[] cursorItem_components = (itemCount.equals(0)) ? ProtocolDeserializers.readFixedArr(buf, aux166 ->Tuple2.readFrom(buf, aux167 ->ProtocolDeserializers.readVarInt(buf), aux168 ->readSwitchOftype()), Tuple2[]::new, cursorItem_components_addedComponentCount) : null;
					Integer[] cursorItem_removeComponents = (itemCount.equals(0)) ? ProtocolDeserializers.readFixedArr(buf, aux169 ->ProtocolDeserializers.readVarInt(buf), Integer[]::new, cursorItem_removeComponents_removedComponentCount) : null;
			...
			static class packet_edit_book extends PacketBase{
				...
				public static packet_edit_book readFrom(ByteBuffer buf){
					Integer hand = ProtocolDeserializers.readVarInt(buf);
					String[] pages = ProtocolDeserializers.readVarintPrefixedArr(buf, aux170 ->ProtocolDeserializers.readString(buf), String[]::new);
					Object title_option = "nullNOKNOWNCLASS@FlattenableBuilder";
			...
			static class packet_use_entity extends PacketBase{
				...
				public static packet_use_entity readFrom(ByteBuffer buf){
					...
					Float x = (mouse.equals(2)) ? ProtocolDeserializers.readF32(buf) : null;
					Float y = (mouse.equals(2)) ? ProtocolDeserializers.readF32(buf) : null;
					Float z = (mouse.equals(2)) ? ProtocolDeserializers.readF32(buf) : null;
					Integer hand = (mouse.equals(0))||(mouse.equals(2)) ? ProtocolDeserializers.readVarInt(buf) : null;
			...
			static class packet_advancement_tab extends PacketBase{
				...
				public static packet_advancement_tab readFrom(ByteBuffer buf){
					Integer action = ProtocolDeserializers.readVarInt(buf);
					String tabId = (action.equals(0)) ? ProtocolDeserializers.readString(buf) : null;
			...
			static class packet_set_beacon_effect extends PacketBase{
				//Unresolved buildable option
				Object primary_effect_option;
				//Unresolved buildable option
				Object secondary_effect_option;
				public packet_set_beacon_effect(
					Object primary_effect_option,
					Object secondary_effect_option
				){
					super(PacketIDs.play_toServer_packet_set_beacon_effect.getId());
					this.primary_effect_option = primary_effect_option;
					this.secondary_effect_option = secondary_effect_option;
				}
				public static packet_set_beacon_effect readFrom(ByteBuffer buf){
					Object primary_effect_option = "nullNOKNOWNCLASS@FlattenableBuilder";
					Object secondary_effect_option = "nullNOKNOWNCLASS@FlattenableBuilder";
					return new packet_set_beacon_effect(
						primary_effect_option,
						secondary_effect_option
					);
				}
			}
			static class packet_held_item_slot extends PacketBase{
			...
			static class packet_set_creative_slot extends PacketBase{
				...
				public static packet_set_creative_slot readFrom(ByteBuffer buf){
					...
					Integer item_addedComponentCount = (itemCount.equals(0)) ? ProtocolDeserializers.readVarInt(buf) : null;
					Integer item_removedComponentCount = (itemCount.equals(0)) ? ProtocolDeserializers.readVarInt(buf) : null;
					Tuple2<Integer, Object>[] item_components = (itemCount.equals(0)) ? ProtocolDeserializers.readFixedArr(buf, aux171 ->Tuple2.readFrom(buf, aux172 ->ProtocolDeserializers.readVarInt(buf), aux173 ->readSwitchOftype()), Tuple2[]::new, item_components_addedComponentCount) : null;
					Integer[] item_removeComponents = (itemCount.equals(0)) ? ProtocolDeserializers.readFixedArr(buf, aux174 ->ProtocolDeserializers.readVarInt(buf), Integer[]::new, item_removeComponents_removedComponentCount) : null;
