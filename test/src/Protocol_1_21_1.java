	...
	public static class login{
		public static class toClient{
			...
			static class packet_encryption_begin extends PacketBase{
				...
				public static packet_encryption_begin readFrom(ByteBuffer buf){
					...
					Boolean[] publicKey = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readBit(buf), Boolean[]::new);
					Boolean[] verifyToken = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readBit(buf), Boolean[]::new);
			...
			static class packet_success extends PacketBase{
				...
				public static packet_success readFrom(ByteBuffer buf){
					...
					Tuple3<String, String, Object>[] properties = ProtocolDeserializers.readVarintPrefixedArr(buf, Tuple3.readFrom(buf, aux ->ProtocolDeserializers.readString(buf), aux ->ProtocolDeserializers.readString(buf), nullNOKNOWNCLASS), Tuple3[]::new);
		...
		public static class toServer{
			...
			static class packet_encryption_begin extends PacketBase{
				...
				public static packet_encryption_begin readFrom(ByteBuffer buf){
					Boolean[] sharedSecret = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readBit(buf), Boolean[]::new);
					Boolean[] verifyToken = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readBit(buf), Boolean[]::new);
					return new packet_encryption_begin(
						sharedSecret,
						verifyToken
			...
			static class packet_login_plugin_response extends PacketBase{
				...
				public static packet_login_plugin_response readFrom(ByteBuffer buf){
					Integer messageId = ProtocolDeserializers.readVarInt(buf);
					Object data_option = nullNOKNOWNCLASS;
	...
	public static class configuration{
		public static class toClient{
			...
			static class packet_disconnect extends PacketBase{
				...
				public static packet_disconnect readFrom(ByteBuffer buf){
					String reason = ProtocolDeserializers.anonymousNbtDeserializer(buf);
					return new packet_disconnect(
						reason
					);
				}
			...
			static class packet_registry_data extends PacketBase{
				...
				public static packet_registry_data readFrom(ByteBuffer buf){
					...
					Tuple2<String, Object>[] entries = ProtocolDeserializers.readVarintPrefixedArr(buf, Tuple2.readFrom(buf, aux ->ProtocolDeserializers.readString(buf), nullNOKNOWNCLASS), Tuple2[]::new);
			...
			static class packet_remove_resource_pack extends PacketBase{
				...
				public static packet_remove_resource_pack readFrom(ByteBuffer buf){
					Object uuid_option = nullNOKNOWNCLASS;
			...
			static class packet_add_resource_pack extends PacketBase{
				...
				public static packet_add_resource_pack readFrom(ByteBuffer buf){
					...
					Object promptMessage_option = nullNOKNOWNCLASS;
			...
			static class packet_feature_flags extends PacketBase{
				...
				public static packet_feature_flags readFrom(ByteBuffer buf){
					String[] features = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readString(buf), String[]::new);
			...
			static class packet_tags extends PacketBase{
				...
				public static packet_tags readFrom(ByteBuffer buf){
					Tuple2<String, Tuple2<String, Integer[]>[]>[] tags = ProtocolDeserializers.readVarintPrefixedArr(buf, Tuple2.readFrom(buf, aux ->ProtocolDeserializers.readString(buf), aux ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->Tuple2.readFrom(buf, aux ->ProtocolDeserializers.readString(buf), aux ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readVarInt(buf), Integer[]::new)), Tuple2[]::new)), Tuple2[]::new);
	...
	public static class play{
		public static class toClient{
			...
			static class packet_statistics extends PacketBase{
				...
				public static packet_statistics readFrom(ByteBuffer buf){
					Tuple3<Integer, Integer, Integer>[] entries = ProtocolDeserializers.readVarintPrefixedArr(buf, Tuple3.readFrom(buf, aux ->ProtocolDeserializers.readVarInt(buf), aux ->ProtocolDeserializers.readVarInt(buf), aux ->ProtocolDeserializers.readVarInt(buf)), Tuple3[]::new);
			...
			static class packet_block_break_animation extends PacketBase{
				Integer entityId;
				//bitfield of size: 26
				BitfieldField location_x;
				//bitfield of size: 26
				BitfieldField location_z;
				//bitfield of size: 12
				BitfieldField location_y;
				Byte destroyStage;
				...
				public static packet_block_break_animation readFrom(ByteBuffer buf){
					Integer entityId = ProtocolDeserializers.readVarInt(buf);
					BitfieldField location_x = READBITFIELD(buf);
					BitfieldField location_z = READBITFIELD(buf);
					BitfieldField location_y = READBITFIELD(buf);
			...
			static class packet_tile_entity_data extends PacketBase{
				...
				public static packet_tile_entity_data readFrom(ByteBuffer buf){
					...
					String nbtData = ProtocolDeserializers.anonOptionalNbtDeserializer(buf);
			...
			static class packet_boss_bar extends PacketBase{
				...
				public static packet_boss_bar readFrom(ByteBuffer buf){
					...
					Integer action = ProtocolDeserializers.readVarInt(buf);
					String title = (action.equals(0))||(action.equals(3)) ? ProtocolDeserializers.anonymousNbtDeserializer(buf) : null;
			...
			static class packet_chunk_biomes extends PacketBase{
				Tuple3<Integer, Integer, Boolean[]>[] biomes;
				...
				public static packet_chunk_biomes readFrom(ByteBuffer buf){
					Tuple3<Integer, Integer, Boolean[]>[] biomes = ProtocolDeserializers.readVarintPrefixedArr(buf, Tuple3.readFrom(buf, aux ->ProtocolDeserializers.readI32(buf), aux ->ProtocolDeserializers.readI32(buf), aux ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readBit(buf), Boolean[]::new)), Tuple3[]::new);
			...
			static class packet_tab_complete extends PacketBase{
				...
				public static packet_tab_complete readFrom(ByteBuffer buf){
					...
					Tuple2<String, Object>[] matches = ProtocolDeserializers.readVarintPrefixedArr(buf, Tuple2.readFrom(buf, aux ->ProtocolDeserializers.readString(buf), nullNOKNOWNCLASS), Tuple2[]::new);
			...
			static class packet_declare_commands extends PacketBase{
				Tuple8<BitfieldField, BitfieldField, BitfieldField, BitfieldField, BitfieldField, Integer[], Object, Object>[] nodes;
				Integer rootIndex;
				...
				public static packet_declare_commands readFrom(ByteBuffer buf){
					Tuple8<BitfieldField, BitfieldField, BitfieldField, BitfieldField, BitfieldField, Integer[], Object, Object>[] nodes = ProtocolDeserializers.readVarintPrefixedArr(buf, Tuple8.readFrom(buf, aux ->READBITFIELD(buf), aux ->READBITFIELD(buf), aux ->READBITFIELD(buf), aux ->READBITFIELD(buf), aux ->READBITFIELD(buf), aux ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readVarInt(buf), Integer[]::new), "readSwitchOfflags/has_redirect_node{}", "readSwitchOfflags/command_node_type{}"), Tuple8[]::new);
			...
			static class packet_window_items extends PacketBase{
				...
				FieldArrayBuildable carriedItem_components;
				FieldArrayBuildable carriedItem_removeComponents;
				...
				public static packet_window_items readFrom(ByteBuffer buf){
					...
					Tuple2<Byte, Object>[] items = ProtocolDeserializers.readVarintPrefixedArr(buf, Tuple2.readFrom(buf, aux ->ProtocolDeserializers.readI8(buf), "readSwitchOfitemCount{}"), Tuple2[]::new);
					...
					FieldArrayBuildable carriedItem_components = (itemCount.equals(0)) ? fieldARRREAD : null;
					FieldArrayBuildable carriedItem_removeComponents = (itemCount.equals(0)) ? fieldARRREAD : null;
			...
			static class packet_set_slot extends PacketBase{
				...
				FieldArrayBuildable item_components;
				FieldArrayBuildable item_removeComponents;
				...
				public static packet_set_slot readFrom(ByteBuffer buf){
					...
					FieldArrayBuildable item_components = (itemCount.equals(0)) ? fieldARRREAD : null;
					FieldArrayBuildable item_removeComponents = (itemCount.equals(0)) ? fieldARRREAD : null;
			...
			static class packet_chat_suggestions extends PacketBase{
				...
				public static packet_chat_suggestions readFrom(ByteBuffer buf){
					Integer action = ProtocolDeserializers.readVarInt(buf);
					String[] entries = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readString(buf), String[]::new);
			...
			static class packet_damage_event extends PacketBase{
				...
				public static packet_damage_event readFrom(ByteBuffer buf){
					...
					Object sourcePosition_option = nullNOKNOWNCLASS;
			...
			static class packet_debug_sample extends PacketBase{
				...
				public static packet_debug_sample readFrom(ByteBuffer buf){
					Long[] sample = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readI64(buf), Long[]::new);
					Integer type = ProtocolDeserializers.readVarInt(buf);
			...
			static class packet_hide_message extends PacketBase{
				...
				public static packet_hide_message readFrom(ByteBuffer buf){
					...
					Boolean[] signature = (id.equals(0)) ? ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readBit(buf), Boolean[]::new) : null;
			...
			nullnullnullstatic class packet_profileless_chat extends PacketBase{
				...
				public static packet_profileless_chat readFrom(ByteBuffer buf){
					String message = ProtocolDeserializers.anonymousNbtDeserializer(buf);
					...
					Integer[] type_chat_parameters = (registryIndex.equals(0)) ? ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readVarInt(buf), Integer[]::new) : null;
					String type_chat_style = (registryIndex.equals(0)) ? ProtocolDeserializers.anonymousNbtDeserializer(buf) : null;
					String type_narration_translationKey = (registryIndex.equals(0)) ? ProtocolDeserializers.readString(buf) : null;
					Integer[] type_narration_parameters = (registryIndex.equals(0)) ? ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readVarInt(buf), Integer[]::new) : null;
					String type_narration_style = (registryIndex.equals(0)) ? ProtocolDeserializers.anonymousNbtDeserializer(buf) : null;
					String name = ProtocolDeserializers.anonymousNbtDeserializer(buf);
					Object target_option = nullNOKNOWNCLASS;
			...
			static class packet_explosion extends PacketBase{
				...
				FieldArrayBuildable small_explosion_particle_data_components;
				FieldArrayBuildable small_explosion_particle_data_removeComponents;
				...
				FieldArrayBuildable large_explosion_particle_data_components;
				FieldArrayBuildable large_explosion_particle_data_removeComponents;
				...
				public static packet_explosion readFrom(ByteBuffer buf){
					...
					Tuple3<Byte, Byte, Byte>[] affectedBlockOffsets = ProtocolDeserializers.readVarintPrefixedArr(buf, Tuple3.readFrom(buf, aux ->ProtocolDeserializers.readI8(buf), aux ->ProtocolDeserializers.readI8(buf), aux ->ProtocolDeserializers.readI8(buf)), Tuple3[]::new);
					...
					FieldArrayBuildable small_explosion_particle_data_components = (small_explosion_particle_type.equals(small_explosion_particle_type_map.get("item"))) ? (small_explosion_particle_data_itemCount.equals(small_explosion_particle_data_0)) ? fieldARRREAD : null : null;
					FieldArrayBuildable small_explosion_particle_data_removeComponents = (small_explosion_particle_type.equals(small_explosion_particle_type_map.get("item"))) ? (small_explosion_particle_data_itemCount.equals(small_explosion_particle_data_0)) ? fieldARRREAD : null : null;
					...
					Object small_explosion_particle_data_position = (small_explosion_particle_type.equals(small_explosion_particle_type_map.get("vibration"))) ? (small_explosion_particle_data_position_type.equals(small_explosion_particle_data_position_type_map.get("block"))) ? nullNOKNOWNCLASS : null : null;
					...
					FieldArrayBuildable large_explosion_particle_data_components = (large_explosion_particle_type.equals(large_explosion_particle_type_map.get("item"))) ? (large_explosion_particle_data_itemCount.equals(large_explosion_particle_data_0)) ? fieldARRREAD : null : null;
					FieldArrayBuildable large_explosion_particle_data_removeComponents = (large_explosion_particle_type.equals(large_explosion_particle_type_map.get("item"))) ? (large_explosion_particle_data_itemCount.equals(large_explosion_particle_data_0)) ? fieldARRREAD : null : null;
					...
					Object large_explosion_particle_data_position = (large_explosion_particle_type.equals(large_explosion_particle_type_map.get("vibration"))) ? (large_explosion_particle_data_position_type.equals(large_explosion_particle_data_position_type_map.get("block"))) ? nullNOKNOWNCLASS : null : null;
					...
					Object range_option = (soundId.equals(0)) ? nullNOKNOWNCLASS : null;
			...
			static class packet_map_chunk extends PacketBase{
				...
				String heightmaps;
				Boolean[] chunkData;
				Tuple5<BitfieldField, BitfieldField, Short, Integer, String>[] blockEntities;
				Long[] skyLightMask;
				Long[] blockLightMask;
				...
				public static packet_map_chunk readFrom(ByteBuffer buf){
					...
					String heightmaps = ProtocolDeserializers.anonymousNbtDeserializer(buf);
					Boolean[] chunkData = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readBit(buf), Boolean[]::new);
					Tuple5<BitfieldField, BitfieldField, Short, Integer, String>[] blockEntities = ProtocolDeserializers.readVarintPrefixedArr(buf, Tuple5.readFrom(buf, aux ->READBITFIELD(buf), aux ->READBITFIELD(buf), aux ->ProtocolDeserializers.readI16(buf), aux ->ProtocolDeserializers.readVarInt(buf), aux ->ProtocolDeserializers.anonOptionalNbtDeserializer(buf)), Tuple5[]::new);
					Long[] skyLightMask = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readI64(buf), Long[]::new);
					Long[] blockLightMask = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readI64(buf), Long[]::new);
					Long[] emptySkyLightMask = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readI64(buf), Long[]::new);
					Long[] emptyBlockLightMask = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readI64(buf), Long[]::new);
					Short[][] skyLight = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readU8(buf), Short[]::new), Short[]::new);
					Short[][] blockLight = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readU8(buf), Short[]::new), Short[]::new);
			...
			static class packet_world_particles extends PacketBase{
				...
				FieldArrayBuildable particle_data_components;
				FieldArrayBuildable particle_data_removeComponents;
				...
				public static packet_world_particles readFrom(ByteBuffer buf){
					...
					FieldArrayBuildable particle_data_components = (particle_type.equals(particle_type_map.get("item"))) ? (particle_data_itemCount.equals(particle_data_0)) ? fieldARRREAD : null : null;
					FieldArrayBuildable particle_data_removeComponents = (particle_type.equals(particle_type_map.get("item"))) ? (particle_data_itemCount.equals(particle_data_0)) ? fieldARRREAD : null : null;
					...
					Object particle_data_position = (particle_type.equals(particle_type_map.get("vibration"))) ? (particle_data_position_type.equals(particle_data_position_type_map.get("block"))) ? nullNOKNOWNCLASS : null : null;
			...
			static class packet_login extends PacketBase{
				...
				public static packet_login readFrom(ByteBuffer buf){
					...
					String[] worldNames = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readString(buf), String[]::new);
			...
			static class packet_map extends PacketBase{
				...
				public static packet_map readFrom(ByteBuffer buf){
					...
					Boolean[] data = (columns.equals(0)) ? ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readBit(buf), Boolean[]::new) : null;
			...
			static class packet_trade_list extends PacketBase{
				Integer windowId;
				Tuple14<Integer, Integer, Integer, FieldArrayBuildable, Byte, Object, Object, Boolean, Integer, Integer, Integer, Integer, Float, Integer>[] trades;
				...
				public static packet_trade_list readFrom(ByteBuffer buf){
					...
					Tuple14<Integer, Integer, Integer, FieldArrayBuildable, Byte, Object, Object, Boolean, Integer, Integer, Integer, Integer, Float, Integer>[] trades = ProtocolDeserializers.readVarintPrefixedArr(buf, Tuple14.readFrom(buf, aux ->ProtocolDeserializers.readVarInt(buf), aux ->ProtocolDeserializers.readVarInt(buf), aux ->ProtocolDeserializers.readVarInt(buf), fieldARRREAD, aux ->ProtocolDeserializers.readI8(buf), "readSwitchOfitemCount{}", nullNOKNOWNCLASS, aux ->ProtocolDeserializers.readBool(buf), aux ->ProtocolDeserializers.readI32(buf), aux ->ProtocolDeserializers.readI32(buf), aux ->ProtocolDeserializers.readI32(buf), aux ->ProtocolDeserializers.readI32(buf), aux ->ProtocolDeserializers.readF32(buf), aux ->ProtocolDeserializers.readI32(buf)), Tuple14[]::new);
			...
			static class packet_open_window extends PacketBase{
				...
				public static packet_open_window readFrom(ByteBuffer buf){
					...
					String windowTitle = ProtocolDeserializers.anonymousNbtDeserializer(buf);
			...
			static class packet_player_chat extends PacketBase{
				...
				public static packet_player_chat readFrom(ByteBuffer buf){
					...
					Tuple2<Integer, Object>[] previousMessages = ProtocolDeserializers.readVarintPrefixedArr(buf, Tuple2.readFrom(buf, aux ->ProtocolDeserializers.readVarInt(buf), "readSwitchOfid{}"), Tuple2[]::new);
					Object unsignedChatContent_option = nullNOKNOWNCLASS;
					Integer filterType = ProtocolDeserializers.readVarInt(buf);
					Long[] filterTypeMask = (filterType.equals(2)) ? ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readI64(buf), Long[]::new) : null;
					Integer type_registryIndex = ProtocolDeserializers.readVarInt(buf);
					String type_chat_translationKey = (registryIndex.equals(0)) ? ProtocolDeserializers.readString(buf) : null;
					Integer[] type_chat_parameters = (registryIndex.equals(0)) ? ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readVarInt(buf), Integer[]::new) : null;
					String type_chat_style = (registryIndex.equals(0)) ? ProtocolDeserializers.anonymousNbtDeserializer(buf) : null;
					...
					Integer[] type_narration_parameters = (registryIndex.equals(0)) ? ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readVarInt(buf), Integer[]::new) : null;
					String type_narration_style = (registryIndex.equals(0)) ? ProtocolDeserializers.anonymousNbtDeserializer(buf) : null;
					String networkName = ProtocolDeserializers.anonymousNbtDeserializer(buf);
					Object networkTargetName_option = nullNOKNOWNCLASS;
			...
			static class packet_player_remove extends PacketBase{
				...
				public static packet_player_remove readFrom(ByteBuffer buf){
					BigInteger[] players = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readUUID(buf), BigInteger[]::new);
			...
			static class packet_player_info extends PacketBase{
				...
				public static packet_player_info readFrom(ByteBuffer buf){
					...
					Tuple7<BigInteger, Object, Object, Object, Object, Object, Object>[] data = ProtocolDeserializers.readVarintPrefixedArr(buf, Tuple7.readFrom(buf, aux ->ProtocolDeserializers.readUUID(buf), "readSwitchOf../action{}", "readSwitchOf../action{}", "readSwitchOf../action{}", "readSwitchOf../action{}", "readSwitchOf../action{}", "readSwitchOf../action{}"), Tuple7[]::new);
			...
			static class packet_face_player extends PacketBase{
				...
				public static packet_face_player readFrom(ByteBuffer buf){
					...
					Integer entityId = (isEntity.equals(isEntity_map.get("true"))) ? ProtocolDeserializers.readVarInt(buf) : null;
			...
			static class packet_unlock_recipes extends PacketBase{
				...
				public static packet_unlock_recipes readFrom(ByteBuffer buf){
					...
					String[] recipes1 = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readString(buf), String[]::new);
					String[] recipes2 = (action.equals(0)) ? ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readString(buf), String[]::new) : null;
			...
			static class packet_entity_destroy extends PacketBase{
				...
				public static packet_entity_destroy readFrom(ByteBuffer buf){
					Integer[] entityIds = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readVarInt(buf), Integer[]::new);
			...
			static class packet_reset_score extends PacketBase{
				...
				public static packet_reset_score readFrom(ByteBuffer buf){
					...
					Object objective_name_option = nullNOKNOWNCLASS;
			...
			static class packet_multi_block_change extends PacketBase{
				//bitfield of size: 22
				BitfieldField chunkCoordinates_x;
				//bitfield of size: 22
				BitfieldField chunkCoordinates_z;
				//bitfield of size: 20
				BitfieldField chunkCoordinates_y;
				Integer[] records;
				...
				public static packet_multi_block_change readFrom(ByteBuffer buf){
					BitfieldField chunkCoordinates_x = READBITFIELD(buf);
					BitfieldField chunkCoordinates_z = READBITFIELD(buf);
					BitfieldField chunkCoordinates_y = READBITFIELD(buf);
					Integer[] records = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readVarInt(buf), Integer[]::new);
			...
			static class packet_select_advancement_tab extends PacketBase{
				...
				public static packet_select_advancement_tab readFrom(ByteBuffer buf){
					Object id_option = nullNOKNOWNCLASS;
			...
			static class packet_server_data extends PacketBase{
				...
				public static packet_server_data readFrom(ByteBuffer buf){
					String motd = ProtocolDeserializers.anonymousNbtDeserializer(buf);
					Object iconBytes_option = nullNOKNOWNCLASS;
			...
			static class packet_action_bar extends PacketBase{
				...
				public static packet_action_bar readFrom(ByteBuffer buf){
					String text = ProtocolDeserializers.anonymousNbtDeserializer(buf);
			...
			static class packet_entity_metadata extends PacketBase{
				...
				public static packet_entity_metadata readFrom(ByteBuffer buf){
					Integer entityId = ProtocolDeserializers.readVarInt(buf);
					Object metadata_entityMetadataLoop = nullNOKNOWNCLASS;
			...
			static class packet_entity_equipment extends PacketBase{
				...
				public static packet_entity_equipment readFrom(ByteBuffer buf){
					Integer entityId = ProtocolDeserializers.readVarInt(buf);
					Object equipments_topBitSetTerminatedArray = nullNOKNOWNCLASS;
			...
			static class packet_scoreboard_objective extends PacketBase{
				...
				public static packet_scoreboard_objective readFrom(ByteBuffer buf){
					String name = ProtocolDeserializers.readString(buf);
					Byte action = ProtocolDeserializers.readI8(buf);
					String displayText = (action.equals(0))||(action.equals(2)) ? ProtocolDeserializers.anonymousNbtDeserializer(buf) : null;
					Integer type = (action.equals(0))||(action.equals(2)) ? ProtocolDeserializers.readVarInt(buf) : null;
					Object number_format_option = (action.equals(0)) ? nullNOKNOWNCLASS : null;
					Object number_format_option = (action.equals(2)) ? nullNOKNOWNCLASS : null;
					String styling = (action.equals(0)) ? (styling_number_format.equals(styling_1))||(styling_number_format.equals(styling_2)) ? ProtocolDeserializers.anonymousNbtDeserializer(buf) : null : null;
					String styling = (action.equals(2)) ? (styling_number_format.equals(styling_1))||(styling_number_format.equals(styling_2)) ? ProtocolDeserializers.anonymousNbtDeserializer(buf) : null : null;
			...
			static class packet_set_passengers extends PacketBase{
				...
				public static packet_set_passengers readFrom(ByteBuffer buf){
					Integer entityId = ProtocolDeserializers.readVarInt(buf);
					Integer[] passengers = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readVarInt(buf), Integer[]::new);
			...
			static class packet_teams extends PacketBase{
				...
				public static packet_teams readFrom(ByteBuffer buf){
					...
					String name = (mode.equals(0))||(mode.equals(2)) ? ProtocolDeserializers.anonymousNbtDeserializer(buf) : null;
					...
					String prefix = (mode.equals(0))||(mode.equals(2)) ? ProtocolDeserializers.anonymousNbtDeserializer(buf) : null;
					String suffix = (mode.equals(0))||(mode.equals(2)) ? ProtocolDeserializers.anonymousNbtDeserializer(buf) : null;
					String[] players = (mode.equals(0))||(mode.equals(3))||(mode.equals(4)) ? ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readString(buf), String[]::new) : null;
			...
			static class packet_scoreboard_score extends PacketBase{
				...
				public static packet_scoreboard_score readFrom(ByteBuffer buf){
					...
					Object display_name_option = nullNOKNOWNCLASS;
					Object number_format_option = nullNOKNOWNCLASS;
					String styling = (number_format.equals(1))||(number_format.equals(2)) ? ProtocolDeserializers.anonymousNbtDeserializer(buf) : null;
			...
			static class packet_entity_sound_effect extends PacketBase{
				...
				public static packet_entity_sound_effect readFrom(ByteBuffer buf){
					...
					Object soundEvent_range_option = (soundId.equals(0)) ? nullNOKNOWNCLASS : null;
			...
			static class packet_system_chat extends PacketBase{
				...
				public static packet_system_chat readFrom(ByteBuffer buf){
					String content = ProtocolDeserializers.anonymousNbtDeserializer(buf);
			...
			static class packet_playerlist_header extends PacketBase{
				...
				public static packet_playerlist_header readFrom(ByteBuffer buf){
					String header = ProtocolDeserializers.anonymousNbtDeserializer(buf);
					String footer = ProtocolDeserializers.anonymousNbtDeserializer(buf);
			...
			static class packet_nbt_query_response extends PacketBase{
				...
				public static packet_nbt_query_response readFrom(ByteBuffer buf){
					Integer transactionId = ProtocolDeserializers.readVarInt(buf);
					String nbt = ProtocolDeserializers.anonOptionalNbtDeserializer(buf);
			...
			static class packet_advancements extends PacketBase{
				...
				public static packet_advancements readFrom(ByteBuffer buf){
					Boolean reset = ProtocolDeserializers.readBool(buf);
					Tuple5<String, Object, Object, String[][], Boolean>[] advancementMapping = ProtocolDeserializers.readVarintPrefixedArr(buf, Tuple5.readFrom(buf, aux ->ProtocolDeserializers.readString(buf), nullNOKNOWNCLASS, nullNOKNOWNCLASS, aux ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readString(buf), String[]::new), String[]::new), aux ->ProtocolDeserializers.readBool(buf)), Tuple5[]::new);
					String[] identifiers = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readString(buf), String[]::new);
					Tuple2<String, Tuple2<String, Object>[]>[] progressMapping = ProtocolDeserializers.readVarintPrefixedArr(buf, Tuple2.readFrom(buf, aux ->ProtocolDeserializers.readString(buf), aux ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->Tuple2.readFrom(buf, aux ->ProtocolDeserializers.readString(buf), nullNOKNOWNCLASS), Tuple2[]::new)), Tuple2[]::new);
			...
			static class packet_entity_update_attributes extends PacketBase{
				...
				public static packet_entity_update_attributes readFrom(ByteBuffer buf){
					Integer entityId = ProtocolDeserializers.readVarInt(buf);
					Tuple3<Integer, Double, Tuple3<String, Double, Byte>[]>[] properties = ProtocolDeserializers.readVarintPrefixedArr(buf, Tuple3.readFrom(buf, aux ->ProtocolDeserializers.readVarInt(buf), aux ->ProtocolDeserializers.readF64(buf), aux ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->Tuple3.readFrom(buf, aux ->ProtocolDeserializers.readString(buf), aux ->ProtocolDeserializers.readF64(buf), aux ->ProtocolDeserializers.readI8(buf)), Tuple3[]::new)), Tuple3[]::new);
			...
			static class packet_declare_recipes extends PacketBase{
				...
				public static packet_declare_recipes readFrom(ByteBuffer buf){
					Tuple3<String, Integer, Object>[] recipes = ProtocolDeserializers.readVarintPrefixedArr(buf, Tuple3.readFrom(buf, aux ->ProtocolDeserializers.readString(buf), aux ->ProtocolDeserializers.readVarInt(buf), "readSwitchOftype{}"), Tuple3[]::new);
		...
		public static class toServer{
			...
			static class packet_chat_command_signed extends PacketBase{
				...
				Long timestamp;
				Long salt;
				Tuple2<String, Boolean[]>[] argumentSignatures;
				...
				public static packet_chat_command_signed readFrom(ByteBuffer buf){
					...
					Long timestamp = ProtocolDeserializers.readI64(buf);
					Long salt = ProtocolDeserializers.readI64(buf);
					Tuple2<String, Boolean[]>[] argumentSignatures = ProtocolDeserializers.readVarintPrefixedArr(buf, Tuple2.readFrom(buf, aux ->ProtocolDeserializers.readString(buf), aux ->ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readBit(buf), Boolean[]::new)), Tuple2[]::new);
					Integer messageCount = ProtocolDeserializers.readVarInt(buf);
					Boolean[] acknowledged = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readBit(buf), Boolean[]::new);
			...
			static class packet_chat_session_update extends PacketBase{
				...
				public static packet_chat_session_update readFrom(ByteBuffer buf){
					...
					Boolean[] publicKey = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readBit(buf), Boolean[]::new);
					Boolean[] signature = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readBit(buf), Boolean[]::new);
			...
			static class packet_window_click extends PacketBase{
				...
				FieldArrayBuildable cursorItem_components;
				FieldArrayBuildable cursorItem_removeComponents;
				...
				public static packet_window_click readFrom(ByteBuffer buf){
					...
					Tuple3<Short, Byte, Object>[] changedSlots = ProtocolDeserializers.readVarintPrefixedArr(buf, Tuple3.readFrom(buf, aux ->ProtocolDeserializers.readI16(buf), aux ->ProtocolDeserializers.readI8(buf), "readSwitchOfitemCount{}"), Tuple3[]::new);
					...
					FieldArrayBuildable cursorItem_components = (itemCount.equals(0)) ? fieldARRREAD : null;
					FieldArrayBuildable cursorItem_removeComponents = (itemCount.equals(0)) ? fieldARRREAD : null;
			...
			static class packet_edit_book extends PacketBase{
				...
				public static packet_edit_book readFrom(ByteBuffer buf){
					Integer hand = ProtocolDeserializers.readVarInt(buf);
					String[] pages = ProtocolDeserializers.readVarintPrefixedArr(buf, aux ->ProtocolDeserializers.readString(buf), String[]::new);
					Object title_option = nullNOKNOWNCLASS;
			...
			static class packet_set_beacon_effect extends PacketBase{
				...
				public static packet_set_beacon_effect readFrom(ByteBuffer buf){
					Object primary_effect_option = nullNOKNOWNCLASS;
					Object secondary_effect_option = nullNOKNOWNCLASS;
